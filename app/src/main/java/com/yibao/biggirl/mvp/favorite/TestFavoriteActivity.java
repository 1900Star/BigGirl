...
import com.yibao.biggirl.model.dagger2.component.DaggerFavoriteActivityComponent;
import com.yibao.biggirl.model.dagger2.moduls.TestFavoriteActivityModuls;
 ...
 */
public class TestFavoriteActivity
                   ...
                   SwipeRefreshLayout.OnRefreshListener
{
    ...
    private String TAG = "TestFavoriteActivity";
    ...
    protected void initInject() {
        ...
        DaggerFavoriteActivityComponent component = (DaggerFavoriteActivityComponent) DaggerFavoriteActivityComponent.builder()
                                                                                                                     .testFavoriteActivityModuls(
                                                                                                                             new TestFavoriteActivityModuls(
                                                                                                                                     this))
                                                                                                                     .build();
        component.in(this);
