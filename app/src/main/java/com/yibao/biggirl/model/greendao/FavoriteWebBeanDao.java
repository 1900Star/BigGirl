...
/** 
 * DAO for table "FAVORITE_WEB_BEAN".
*/
public class FavoriteWebBeanDao extends AbstractDao<FavoriteWebBean, Long> {

    public static final String TABLENAME = "FAVORITE_WEB_BEAN";

    /**
     * Properties of entity FavoriteWebBean.<br/>
    ...
    public FavoriteWebBeanDao(DaoConfig config) {
        super(config);
    }
    
    public FavoriteWebBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FAVORITE_WEB_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FAVORITE_WEB_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, FavoriteWebBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, FavoriteWebBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public FavoriteWebBean readEntity(Cursor cursor, int offset) {
        FavoriteWebBean entity = new FavoriteWebBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, FavoriteWebBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(FavoriteWebBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(FavoriteWebBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(FavoriteWebBean entity) {
